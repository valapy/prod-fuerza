...
@section('content')
  ...
  <!-- form start -->
  <?php if (isset($data)): ?>
  <form role="form" method="POST" action="{{ action('CMS\BranchOfficesController@update', $data->id) }}" enctype="multipart/form-data">
  <?php else: ?>
  <form role="form" method="POST" action="{{ action('CMS\BranchOfficesController@store') }}" enctype="multipart/form-data">
  <?php endif; ?>
    ...
    <div class="col-md-6">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">
            <?=(isset($data) ? "Editar concesionaria" : "Nueva concesionaria")?>
          </h3>
        </div>
        <!-- /.box-header -->
