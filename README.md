...
```
cd existing_repo
git remote add origin https://gitlab.com/creadorespy/diesa/marine/web.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/creadorespy/diesa/marine/web/-/settings/integrations)
