...
return [
   ...
   */
   'dimensions' => [
        'size1280x720' => [1280, 720, false], // Home carousel / Product header image / News images
        'size640x320' => [640, 320, false], // News images thumbnail
        'size280x78' => [280, 78, false], // product logo
        'size476x336' => [476, 336, false], // product description image
        'square450' => [450, 450, true], // product image, product more images thumbnails
        'square720' => [720, 720, true], // product more images full size
   ],
